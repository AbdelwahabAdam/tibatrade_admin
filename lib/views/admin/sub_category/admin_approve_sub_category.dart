...
class AdminApproveSubCategoryController extends GetxController {
  ...
  void updateProduct(String id, Map<String, dynamic> updatedProduct) {
    dbRef.child(id).update(updatedProduct).then((_) {
      Get.snackbar('Success', 'Sup Product updated successfully!');
    }).catchError((error) {
...
class AdminApproveSubCategory extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final AdminApproveSubCategoryController controller = Get.put(AdminApproveSubCategoryController());

    return Scaffold(
      appBar: AppBar(
        title: Text('Approve Sup Category'),
      ),
      body: Column(
        children: [
          // Search bar
...
class _EditCategoryPageState extends State<EditCategoryPage> {
  final AdminApproveSubCategoryController controller = Get.find();
